 ...
 * @author Atef
 */
public class AfficherPassagers extends javax.swing.JFrame {

    /**
     * Creates new form AfficherPassagers
     */
    public AfficherPassagers() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Afficher tous les passagers");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CIN", "Passeport", "Nom", "Prenom", "Adresse", "Telephone"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (x==-1) {
            ...
            ModifierPass modif = new ModifierPass();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AfficherPassagers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AfficherPassagers().setVisible(true);
            }
        });
    }
