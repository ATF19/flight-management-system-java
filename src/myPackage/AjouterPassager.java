 ...
 * @author Atef
 */
public class AjouterPassager extends javax.swing.JFrame {

    /**
     * Creates new form AjouterPassager
     */
    public AjouterPassager() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Passager ps = new Passager(Integer.valueOf(cin.getText()),passeport.getText(),nom.getText()+" "+prenom.getText(), adresse.getText(),Long.valueOf(tel.getText()));
        ps.insertBd();
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AjouterPassager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
