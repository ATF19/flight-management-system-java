 ...
 * @author Atef
 */
public class ModifierPass extends javax.swing.JFrame {
    int post;
    /**
     * Creates new form ModifierPass
     */
    public ModifierPass() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Result upd = db.execute("MATCH (n:Personne {cin:"+post+"}) SET n.cin='"+cin.getText()+"', n.numPassport='"+passeport.getText()+"', n.nom='"+nom.getText()+" "+prenom.getText()+"', n.adresse='"+adresse.getText()+"', n.telephone='"+tel.getText()+"' RETURN n");
                upd = db.execute("MATCH (n:Passager {cin:"+post+"}) SET n.cin='"+cin.getText()+"', n.numPassport='"+passeport.getText()+"', n.nom='"+nom.getText()+" "+prenom.getText()+"', n.adresse='"+adresse.getText()+"', n.telephone='"+tel.getText()+"' RETURN n");
        if (!upd.hasNext()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifierPass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifierPass().setVisible(true);
            }
        });
    }
